...
InterchainAccountPacketData = _reflection.GeneratedProtocolMessageType('InterchainAccountPacketData', (_message.Message,), {
...
CosmosTx = _reflection.GeneratedProtocolMessageType('CosmosTx', (_message.Message,), {
