...
from evmospy.evmosproto.cosmos.upgrade.v1beta1 import upgrade_pb2 as cosmos_dot_upgrade_dot_v1beta1_dot_upgrade__pb2
...
UpgradeProposal = _reflection.GeneratedProtocolMessageType('UpgradeProposal', (_message.Message,), {
