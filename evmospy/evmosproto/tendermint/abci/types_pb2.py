...
from evmospy.evmosproto.tendermint.crypto import keys_pb2 as tendermint_dot_crypto_dot_keys__pb2
from evmospy.evmosproto.tendermint.types import params_pb2 as tendermint_dot_types_dot_params__pb2
